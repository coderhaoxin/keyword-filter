...
const KeywordFilter = require('..')

let content1 = 'what is the best lang, go or js?你呀个妹，咿呀我哈噶'
let content2 = '快乐的一天, hello my name is haoxin'
let content3 = 'what is the best lang, go or js?\n' +
  '你呀个妹，咿呀我哈噶'

let keyArrays = ['go', 'js', 'lang', '我哈', '你呀']
...
describe('## keyword filter', function() {
  describe('# getOccurances', function() {
    it('should map line numers and discovered values', function() {
      const results = filter.getOccurances(content3)
